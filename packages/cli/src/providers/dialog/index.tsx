...
const DialogContext = createContext<DialogConfigValue | null>(null);

export function useDialog(): DialogConfigValue {
...
function Dialog({ currentDialog, close }: DialogProps) {
  ...
  return (
    <box
      ...
      alignItems="center"
      backgroundColor={RGBA.fromInts(0, 0, 150)}
      zIndex={100}
      onMouseDown={() => close()}
    >
      <box
