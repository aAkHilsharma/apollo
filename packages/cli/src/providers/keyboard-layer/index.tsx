...
const KeyboardLayerContext = createContext<KeyboardLayerCotextValue | null>(null);
...
export function useKeyboardLayer() {
  ...
  if (!context) {
    throw new Error("useKeyboardLayer must be used within a KeyboardLayerContextProvider")
  }
  return context
}
